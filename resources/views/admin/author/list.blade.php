            ...
            <div class="col-md-10 mx-auto">
                <div class="card mt-4">
                    ...
                    <div class="card-header">
                        <div class="d-flex">
                            <h5 class="card-title text-center">Author List</h5>
                        </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        || <a href="{{ route('author.edit',$author->id) }}"> <button type="button" class="btn btn-warning"> <i class="fa fa-pencil"></i></a></button> 
                                        || <a href="{{ route('author.show',$author->id) }}"> <button type="button" class="btn btn-success"> <i class="fa fa-eye"></i></a></button>
                                    </td>
                                    </tr>
                                    @empty
