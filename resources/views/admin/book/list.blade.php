            ...
            <div class="col-md-10 mx-auto">
                <div class="card mt-4">
                    ...
                    <div class="card-header">
                       ...
                       @endif
                        <div class="text-end">
                            <a href="{{ route('book.create') }}" target="_self" rel="noopener noreferrer"> <button class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i></button></a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        </form> || <a href="{{ route('book.edit',$book->id) }}"> <button type="button" class="btn btn-warning"> <i class="fa fa-pencil"></i></a></button> </td>
                                    </tr>
                                    @empty
